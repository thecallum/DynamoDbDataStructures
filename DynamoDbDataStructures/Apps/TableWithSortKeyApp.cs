...
using TableWithSortKey.Factories;
using TableWithSortKey.UseCase;
...
{
    public class TableWithSortKeyApp
    {
        ...
        public TableWithSortKeyApp(IDynamoDBContext dynamoDbContext)
        {
